...
//		}
		...
		Imovel imovel1 = new Velho("rua1", 500.00);
		Imovel imovel2 = new Novo("rua2", 220.00);
		Imovel imovel3 = new Novo("rua3", 290.00);
		Imovel imovel4 = new Velho("rua4", 300.00);
		Imovel imovel5 = new Novo("rua5", 400.00);
		Imovel imovel6 = new Velho("rua6", 550.00);
		Imovel imovel7 = new Velho("rua7", 666.00);
		Imovel imovel8 = new Velho("rua8", 100.00);
		Imovel imovel9 = new Novo("rua9", 800.00);
